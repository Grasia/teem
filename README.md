...
Previously we recommended that you merge in changes to pear2pear into your own fork of the project.
...
The pear2pear project supports loading the framework and application scripts asynchronously.  The
...
The pear2pear project comes preconfigured with a local development webserver.  It is a node.js
...
to your repository and execute scripts such as building the app or running tests. The pear2pear
